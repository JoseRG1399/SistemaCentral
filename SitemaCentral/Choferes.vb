...
Public Class Choferes
        ...
        For Each item As Sucursales In sucursalesArray
            ...
            Try
                ...
                Try
                    ...
                    cmd15 = New OleDbCommand("DELETE FROM Choferes WHERE Chofer='" & nombre & "'", conexion)
                    conexion.Open()
                ...
                Try
                    ...
                    cmd = New OleDbCommand("INSERT INTO Choferes (Chofer,Clave) VALUES('" & nombre & "','" & password & "')", conexion)
                    conexion.Open()
    ...
    Public Sub AddInOneStoreOnly(branch As String)
        ...
        Dim nombreChofer = txtNombre.Text
        ...
        For Each item As Sucursales In sucursalesArray
            ...
            If branchName = branch Then
                ...
                Catch ex As Exception
                    MsgBox(ex.Message & "Error al establecer la conexion con " & branchName)
                End Try
                ...
                Try
                    ...
                    cmd = New OleDbCommand("INSERT INTO Choferes (Chofer,Clave) VALUES('" & nombreChofer & "','" & password & "')", conexion)
                    conexion.Open()
                    r1 = cmd.ExecuteNonQuery
                    conexion.Close()
                    MsgBox("Chofer agregado con éxito en: " & branchName)

                Catch ex As Exception
                    MsgBox(ex.Message & "Error al dar de alta al chofer")
                    conexion.Close()
    ...
    Public Sub DeleteKey()
        Dim chofer As String = txtNegativeDriver.Text
        contador = 0
        For Each item As Sucursales In sucursalesArray
            Try
                conexion.ConnectionString = "Provider=Microsoft.ACE.OLEDB.12.0;Data Source=\\" + item.getIpDirection + "\Users\Public\Documents\" + item.getNameDB + ".accdb"
            ...
            Try
                Dim cmd15 As New OleDbCommand
                cmd15 = New OleDbCommand("DELETE FROM Choferes WHERE Chofer ='" & chofer & "'", conexion)
                conexion.Open()
                cmd15.ExecuteNonQuery()
                conexion.Close()
                contador += 1
    ...
    Public Sub SearchById()
        ...
        Try
            ...
            buscar_combo = "SELECT * FROM Choferes Where Chofer = '" & nombre & "'"
            adaptador_combo = New OleDbDataAdapter(buscar_combo, conexionLocal)
            tabla_combo = New DataTable
            adaptador_combo.Fill(tabla_combo)
            For Each puntero In tabla_combo.Rows
                Dim password = puntero(1)
                txtUpdatePassword.Text = password
            Next

        Catch ex As Exception
            MsgBox(ex.Message & "Error al asignar la informacion de la vendedora en los texbox")
    ...
    Private Sub btnUpdateSellerInfo_Click(sender As Object, e As EventArgs) Handles btnUpdateSellerInfo.Click
